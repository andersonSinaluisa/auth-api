...
export class AuthService {
    ...
    async terminateSession(session_id: string) {
        const session = await this.sessionService.findSessionById(session_id);

        this.sessionService.terminateSessionById(session_id);
    ...
    async recoveryPassword(email: string) {
        ...
        this.messageService.sendMessage('send-mail', JSON.stringify({
            app_code: 'auth-api',
            to: email,
    ...
    async verify(sessionId: string, token: string) {
